...
$Array | Select-Object -Property "App Name", "Owner UPN", "Usage Count" | Sort-Object -Property "Usage Count" -Descending | Export-Csv -Path "c:\temp\AppsInventoryDate.csv" -NoTypeInformation 
